...
void resoAnaZtoLLjets() {
  ...
  mg_resoPar_vs_nvtx->GetYaxis()->SetRangeUser(25.5,73.0);
  ...
  mg_resoPerp_vs_nvtx->GetYaxis()->SetRangeUser(17.5,30.5);
  ...
  mg_resoPar_vs_ZpT->GetYaxis()->SetRangeUser(25.5,73.0);
  ...
  mg_resoPerp_vs_ZpT->GetYaxis()->SetRangeUser(17.5,30.5);
