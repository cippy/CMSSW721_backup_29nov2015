...
#ifdef zlljetsAna_new_v2_cxx

zlljetsAna_new_v2::zlljetsAna_new_v2(TTree *tree) : edimarcoTree_noSkim(tree) {
...
void zlljetsAna_new_v2::loop(const char* configFileName)
{
   ...
   if (fabs(LEP_PDG_ID) == 13) {  // if we have Z -> mumu do stuff...
     ...
     strcpy(ROOT_FNAME,"zmumujetsAna_v2.root");
     strcpy(TXT_FNAME,"zmumujetsAna_v2.txt");
     strcpy(TEX_FNAME,"zmumujetsAna_v2.tex");
     strcpy(FLAVOUR,"mu");
     ...
     strcpy(ROOT_FNAME,"zeejetsAna_v2.root");
     strcpy(TXT_FNAME,"zeejetsAna_v2.txt");
     strcpy(TEX_FNAME,"zeejetsAna_v2.tex");
     strcpy(FLAVOUR,"ele");
   ...
   cout<<"zlljetsAna_new_v2::loop()"<<endl;
