...
void zlljets_ZpT_recoGenAna(const string fmumuName = "zmumujets_resoResp_noSkim_light.root", const string feeName = "zeejets_resoResp_noSkim_light.root", const char* suffix = "") {
  ...
  cZtomumuPtRecoGen->Divide(1,2,0.01,0);
  cZtomumuPtRecoGen->cd(1);
  subpad1 = (TPad*)cZtomumuPtRecoGen->GetPad(1);
  subpad1->Draw();
  subpad1->SetPad(0.02,0.36,0.98,0.98);
  subpad1->SetRightMargin(0.01);
  subpad1->SetLogy();
  ...
  //hZpTreco[0]->GetYaxis()->SetLabelSize(0.1);
  hZpTreco[0]->Draw("HE");
  ...
  subpad2 = (TPad*)cZtomumuPtRecoGen->GetPad(2);
  subpad2->Draw();
  subpad2->SetPad(0.02,0.01,0.98,0.36);
  subpad2->SetRightMargin(0.01);
  subpad2->SetGrid();
  hZpTrecoGenRatio[0]->GetXaxis()->SetLabelSize(0.08);
  hZpTrecoGenRatio[0]->GetXaxis()->SetTitle("Z_{pT}[GeV]");
  hZpTrecoGenRatio[0]->GetXaxis()->SetTitleSize(0.06);
  hZpTrecoGenRatio[0]->GetXaxis()->SetTitleOffset(1.4);
  ...
  cZtoeePtRecoGen->Divide(1,2,0.01,0);
  ...
  hZpTrecoGenRatio[1]->GetXaxis()->SetTitleOffset(1.4);
